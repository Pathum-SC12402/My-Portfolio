        ...
        <Row>
          <Col md={8} className="home-about-description">
            ...
            <p className="home-about-body">
              ...
              <br />
              <br />
              I’m also deeply interested in areas like <i><b className="purple">DevOps, AI model training</b></i>, and <b className="purple">Machine Learning</b>, constantly looking to expand my knowledge and apply it in impactful ways.
              <br />
              <br />
